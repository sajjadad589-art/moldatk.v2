...
// Recurring ampere discount runs after every historical accounting mutation. Repair
// its own source first because lint and build execute the finalizer more than once.

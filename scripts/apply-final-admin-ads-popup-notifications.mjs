...
if (fs.existsSync(adminPath)) {
  ...
  if (!c.includes('إدارة سلايدات اعلانات')) {
    ...
    const tabOpen = /\{tab === 'notifications' && <div className="[^"]*grid[^\"]*gap-5[^"]*">/;
...
console.log('Final ads manager OK: multi upload, red trash delete, link_url, 3s carousel, app notifications.');

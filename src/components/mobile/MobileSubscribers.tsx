...
const [searchTerm, setSearchTerm] = useState('');
  const [statusFilter, setStatusFilter] = useState<'all' | 'unpaid' | 'paid' | 'partial' | 'free'>(readInitialStatusFilter);
  ...
  return (
    <div className="p-2.5 space-y-2 max-w-lg mx-auto pb-24">
      ...
      <button
        ...
        className="fixed bottom-20 left-3 z-40 w-11 h-11 rounded-2xl bg-blue-600 hover:bg-[#0B1F3B] text-white shadow-xl shadow-blue-500/30 flex items-center justify-center active:scale-95 transition-all"

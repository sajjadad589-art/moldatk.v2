    ...
    if (isNativeAndroid()) {
      try {
        await printSunmiReceipt({
          ...
          systemTitle: template.systemBrandText,
          subTitle: template.subTitle,
          location: template.locationAddress,
          ...
          status: statusText,
          collector: invoice?.collectorName || '',
          ...
          qrDataUrl: template.showQr ? printPortalQrDataUrl : '',
          showLogo: template.showLogo,
          showSystemBrand: template.showSystemBrand,
          showGeneratorName: template.showGeneratorName,
          showSubTitle: template.showSubTitle,
          showDate: template.showDate,
          showReceiptNumber: template.showReceiptNumber,
          showSubscriberName: template.showSubscriberName,
          showPhone: template.showPhone,
          showOwnerPhone: template.showOwnerPhone,
          showLocationAddress: template.showLocationAddress,
          showLineName: template.showLineName,
          showAmperes: template.showAmperes,
          showPricePerAmp: template.showPricePerAmp,
          showPaymentMonth: template.showPaymentMonth,
          showPaymentStatus: template.showPaymentStatus,
          showCollectorName: template.showCollectorName,
          showPreviousDebt: template.showPreviousDebt,
          showCurrentCharge: template.showCurrentCharge,
          showTotalBeforePayment: template.showTotalBeforePayment,
          showAppliedToPreviousDebt: template.showAppliedToPreviousDebt,
          showAppliedToCurrentMonth: template.showAppliedToCurrentMonth,
          showRemainingAfterPayment: template.showRemainingAfterPayment,
          showReceivedAmount: template.showReceivedAmount,
          showThankYou: template.showThankYou,
          showQr: template.showQr,
          showFooterNotes: template.showFooterNotes,
          showFooterSystemText: template.showFooterSystemText,
          dateLabel: template.dateLabel,
          receiptNumberLabel: template.receiptNumberLabel,
          subscriberNameLabel: template.subscriberNameLabel,
          phoneLabel: template.phoneLabel,
          ownerPhoneLabel: template.ownerPhoneLabel,
          locationAddressLabel: template.locationAddressLabel,
          lineNameLabel: template.lineNameLabel,
          amperesLabel: template.amperesLabel,
          pricePerAmpLabel: template.pricePerAmpLabel,
          paymentMonthLabel: template.paymentMonthLabel,
          paymentStatusLabel: template.paymentStatusLabel,
          collectorNameLabel: template.collectorNameLabel,
          previousDebtLabel: template.previousDebtLabel,
          currentChargeLabel: template.currentChargeLabel,
          totalBeforePaymentLabel: template.totalBeforePaymentLabel,
          appliedToPreviousDebtLabel: template.appliedToPreviousDebtLabel,
          appliedToCurrentMonthLabel: template.appliedToCurrentMonthLabel,
          remainingAfterPaymentLabel: template.remainingAfterPaymentLabel,
          receivedAmountLabel: template.receivedAmountLabel,

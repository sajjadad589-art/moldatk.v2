...
export const SuperAdminStorageCard: React.FC = () => {
  ...
  return (
    <section className="mb-5 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
      <div className="flex items-start justify-between gap-6">
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-4 mb-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-black">مساحة التخزين في Supabase</h2>
          ...
          {stats && (
            <div className={`mt-4 rounded-xl px-4 py-3 flex items-center justify-between gap-4 border ${stats.level === 'healthy' ? 'bg-emerald-50 border-emerald-200 text-emerald-800' : stats.level === 'warning' ? 'bg-amber-50 border-amber-200 text-amber-800' : 'bg-rose-50 border-rose-200 text-rose-800'}`}>
